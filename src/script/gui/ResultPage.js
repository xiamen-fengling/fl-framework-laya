...
var ResultPage = /** @class */ (function (_super) {
    ...
    ResultPage.prototype.onOpenGameListPage = function () {
        ...
        FLAnalytics_1["default"].sendUserEvent('UI点击_按钮', { level: GameDataCenter_1["default"].level });
    };
    /**界面打开 */
    ResultPage.prototype.onEnabled = function (param) {
        ...
        FLAnalytics_1["default"].sendUserEvent('进入');
        GameDataCenter_1["default"].prePositionTag = '';
    };
